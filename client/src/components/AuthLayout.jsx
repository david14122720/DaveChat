    ...
    <div className="min-h-screen bg-slate-950 flex items-center justify-center p-4">
      ...
      >
        <div className="text-center mb-8">
          <div className="inline-flex p-3 bg-brand/10 rounded-2xl mb-4 shadow-inner">
            <LogIn className="w-8 h-8 text-brand-light" />
          </div>
          <h1 className="text-3xl font-bold text-white mb-2 tracking-tight">DaveChat</h1>
          <p className="text-slate-400 text-sm font-medium">{isLogin ? 'Accede a tu zona privada' : 'Crea tu perfil de mensajería'}</p>
        </div>
